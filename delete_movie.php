		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-left">
					...
					<li class="active"><a href="delete_movie.php">Obriši film</a></li>
					<li class="dropdown">
	...
	<div class="col-md-6 col-md-offset-3" align="center">
		<div class="jumbotron">
			...
			<form class = "form-horizontal" action ="" method="POST">	
				...
				<input type="submit" name="delete" class="btn-primary" value="Obriši film!">
			</form>
		</div>
	</div>
</div>
...
if (isset($_POST['delete'])){
	if (isset($_POST['movie_name'])&&isset($_POST['year'])){		
		include "conn.php";
		include "new_conn.php";

		$pom=$_POST['movie_name'];
		$pom2=$_POST['year'];
		$sql = "DELETE FROM movies where movie_name='$pom' and year='$pom2'";
		
		if($mysqli->query($sql) == true){
    		echo "<p>Film je uspešno obrisan iz baze.</p>";
		} else{
    		echo "<p>Nastala je greška prilikom brisanja filma.<br>Pokušajte ponovo!</p>";
		}
	     
	}else echo "<p>Nisu prosledjeni parametri</p>";
	$mysqli->close();
}
?>
